...
{//消息类型的枚举，用于标识消息的类型
    ...
    ENUM_MSG_TYPE_FRIEND_PRESENCE_SNAPSHOT_REQUEST,
    ENUM_MSG_TYPE_FRIEND_PRESENCE_SNAPSHOT_RESPOND,
    ENUM_MSG_TYPE_FRIEND_ONLINE_NOTIFY,
    ENUM_MSG_TYPE_FRIEND_OFFLINE_NOTIFY,

    //图形验证码
    ENUM_MSG_TYPE_CAPTCHA_REQUEST,
    ENUM_MSG_TYPE_CAPTCHA_RESPOND,
    ENUM_MSG_TYPE_LOGIN_WITH_CAPTCHA_REQUEST,
    ENUM_MSG_TYPE_LOGIN_WITH_CAPTCHA_RESPOND,
